...
class HtmlTagBuilderTest extends TestCase
{
    ...
    public function testBuid_appendChild()
    {
        $child = new HtmlTagBuilder('p');
        $child ->setTagContent('child');
...
EOL;
    ...
    function testBuild_multipleChildren()
    {
        ...
        $middle2 = new HtmlTagBuilder('img');
        $middle2->addTagAttribute('src', 'image.jpg');
